...
= 7.1.7.0 (April 21st, 2023) =

# Bugs fixed
* Microthemer CSS assets loaded on the Bricks editing interface, which runs on the frontend.
...
= 7.1.6.8 (Jan 12th, 2023) =

# Change
* Microthemer does not auto-apply CSS units to CSS property fields if calc() is used anywhere in the field.

# Bugs fixed
* Removed some deprecated PHP functions.
